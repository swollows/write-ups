...
# 문제에서 사용하는 각종 정보 추출
MAIN_URL = "http://host8.dreamhack.games:20878"
FILE_NM = "./token_info"
...
with open("./sc-king-of-dreamhack/src/Attacker.sol", "r") as f:
...
BASE_DIR = os.path.dirname(current_file) + "/sc-king-of-dreamhack"
