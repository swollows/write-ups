...
public final class UHexExtensionsKt {
    ...
    private static final String m1583toHexStringzHuV2wU(byte[] $this$toHexString_u2dzHuV2wU, HexFormat format) {
    ...
    static /* synthetic */ String m1584toHexStringzHuV2wU$default(byte[] $this$toHexString_u2dzHuV2wU_u24default, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    static /* synthetic */ String m1580toHexStringlZCiFrA$default(byte[] $this$toHexString_u2dlZCiFrA_u24default, int startIndex, int endIndex, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            startIndex = 0;
        }
        if ((i & 2) != 0) {
            endIndex = UByteArray.m358getSizeimpl($this$toHexString_u2dlZCiFrA_u24default);
        }
        if ((i & 4) != 0) {
            format = HexFormat.Companion.getDefault();
        }
    ...
    private static final String m1579toHexStringlZCiFrA(byte[] $this$toHexString_u2dlZCiFrA, int startIndex, int endIndex, HexFormat format) {
    ...
    static /* synthetic */ byte[] hexToUByteArray$default(String $this$hexToUByteArray_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByteArray.m352constructorimpl(HexExtensionsKt.hexToByteArray($this$hexToUByteArray_u24default, format));
    }
    ...
    private static final byte[] hexToUByteArray(String $this$hexToUByteArray, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByteArray.m352constructorimpl(HexExtensionsKt.hexToByteArray($this$hexToUByteArray, format));
    }
    ...
    private static final byte hexToUByte(String $this$hexToUByte, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByte.m299constructorimpl(HexExtensionsKt.hexToByte($this$hexToUByte, format));
    }
    ...
    static /* synthetic */ byte hexToUByte$default(String $this$hexToUByte_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByte.m299constructorimpl(HexExtensionsKt.hexToByte($this$hexToUByte_u24default, format));
    }
    ...
    private static final short hexToUShort(String $this$hexToUShort, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UShort.m562constructorimpl(HexExtensionsKt.hexToShort($this$hexToUShort, format));
    }
    ...
    static /* synthetic */ short hexToUShort$default(String $this$hexToUShort_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UShort.m562constructorimpl(HexExtensionsKt.hexToShort($this$hexToUShort_u24default, format));
    }
    ...
    private static final int hexToUInt(String $this$hexToUInt, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UInt.m376constructorimpl(HexExtensionsKt.hexToInt($this$hexToUInt, format));
    }
    ...
    static /* synthetic */ int hexToUInt$default(String $this$hexToUInt_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UInt.m376constructorimpl(HexExtensionsKt.hexToInt($this$hexToUInt_u24default, format));
    }
    ...
    private static final long hexToULong(String $this$hexToULong, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return ULong.m455constructorimpl(HexExtensionsKt.hexToLong($this$hexToULong, format));
    }
    ...
    static /* synthetic */ long hexToULong$default(String $this$hexToULong_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return ULong.m455constructorimpl(HexExtensionsKt.hexToLong($this$hexToULong_u24default, format));
    }
}
