...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1602getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1603minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1753minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1601elapsedNowUwyO8pc() {
        return Duration.m1648minusLRDsOJo(this.mark.m1750elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1604plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1649plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
