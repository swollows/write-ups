...
public final class LinkedHashSetSerializer<E> extends CollectionSerializer<E, Set<? extends E>, LinkedHashSet<E>> {
    ...
    /* access modifiers changed from: protected */
    public int builderSize(LinkedHashSet<E> $this$builderSize) {
        Intrinsics.checkNotNullParameter($this$builderSize, "<this>");
        return $this$builderSize.size();
    }

    /* access modifiers changed from: protected */
    public Set<E> toResult(LinkedHashSet<E> $this$toResult) {
        Intrinsics.checkNotNullParameter($this$toResult, "<this>");
        return $this$toResult;
    }

    /* access modifiers changed from: protected */
    public LinkedHashSet<E> toBuilder(Set<? extends E> $this$toBuilder) {
    ...
    /* access modifiers changed from: protected */
    public void checkCapacity(LinkedHashSet<E> $this$checkCapacity, int size) {
        Intrinsics.checkNotNullParameter($this$checkCapacity, "<this>");
    }

    /* access modifiers changed from: protected */
    public void insert(LinkedHashSet<E> $this$insert, int index, E element) {
