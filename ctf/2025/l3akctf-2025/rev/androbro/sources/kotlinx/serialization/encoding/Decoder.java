...
public interface Decoder {
    ...
    public static final class DefaultImpls {
        ...
        public static <T> T decodeNullableSerializableValue(Decoder $this, DeserializationStrategy<? extends T> deserializer) {
            ...
            return (deserializer.getDescriptor().isNullable() || $this$decodeIfNullable$iv.decodeNotNullMark()) ? $this.decodeSerializableValue(deserializer) : $this$decodeIfNullable$iv.decodeNull();
        }
    }
}
