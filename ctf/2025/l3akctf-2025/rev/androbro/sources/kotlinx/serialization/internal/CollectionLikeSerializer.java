...
public abstract class CollectionLikeSerializer<Element, Collection, Builder> extends AbstractCollectionSerializer<Element, Collection, Builder> {
    ...
    private CollectionLikeSerializer(KSerializer<Element> elementSerializer2) {
        super((DefaultConstructorMarker) null);
        this.elementSerializer = elementSerializer2;
    }
    ...
    public void serialize(Encoder encoder, Collection value) {
        ...
        for (int index = 0; index < size; index++) {
            $this$serialize_u24lambda_u240.encodeSerializableElement(getDescriptor(), index, this.elementSerializer, iterator.next());
        }
