...
public final class ClassSerialDescriptorBuilder {
    ...
    public ClassSerialDescriptorBuilder(String serialName2) {
    ...
    public final void element(String elementName, SerialDescriptor descriptor, List<? extends Annotation> annotations2, boolean isOptional) {
        ...
        if (this.uniqueNames.add(elementName)) {
            ...
            this.elementAnnotations.add(annotations2);
