...
public final class LinkedHashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, LinkedHashMap<K, V>> {
    ...
    /* access modifiers changed from: protected */
    public int builderSize(LinkedHashMap<K, V> $this$builderSize) {
        Intrinsics.checkNotNullParameter($this$builderSize, "<this>");
        return $this$builderSize.size() * 2;
    }

    /* access modifiers changed from: protected */
    public Map<K, V> toResult(LinkedHashMap<K, V> $this$toResult) {
        Intrinsics.checkNotNullParameter($this$toResult, "<this>");
        return $this$toResult;
    }

    /* access modifiers changed from: protected */
    public LinkedHashMap<K, V> toBuilder(Map<K, ? extends V> $this$toBuilder) {
    ...
    /* access modifiers changed from: protected */
    public void checkCapacity(LinkedHashMap<K, V> $this$checkCapacity, int size) {
        Intrinsics.checkNotNullParameter($this$checkCapacity, "<this>");
    }

    /* access modifiers changed from: protected */
    public void insertKeyValuePair(LinkedHashMap<K, V> $this$insertKeyValuePair, int index, K key, V value) {
