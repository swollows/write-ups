...
public final class SerializersModuleBuilder implements SerializersModuleCollector {
    ...
    public <T> void contextual(KClass<T> kClass, KSerializer<T> serializer) {
        ...
        registerSerializer$default(this, kClass, new ContextualProvider.Argless(serializer), false, 4, (Object) null);
    }

    public <T> void contextual(KClass<T> kClass, Function1<? super List<? extends KSerializer<?>>, ? extends KSerializer<?>> provider) {
        Intrinsics.checkNotNullParameter(kClass, "kClass");
        Intrinsics.checkNotNullParameter(provider, "provider");
        registerSerializer$default(this, kClass, new ContextualProvider.WithTypeArguments(provider), false, 4, (Object) null);
    }
    ...
    public final <T> void registerSerializer(KClass<T> forClass, ContextualProvider provider, boolean allowOverwrite) {
        ...
        Intrinsics.checkNotNullParameter(provider, "provider");
        if (allowOverwrite || (previous = this.class2ContextualProvider.get(forClass)) == null || Intrinsics.areEqual((Object) previous, (Object) provider)) {
    ...
    public final <Base, Sub extends Base> void registerPolymorphicSerializer(KClass<Base> baseClass, KClass<Sub> concreteClass, KSerializer<Sub> concreteSerializer, boolean allowOverwrite) {
        ...
        Map $this$getOrPut$iv = this.polyBase2Serializers;
        ...
        Map baseClassSerializers = (Map) answer$iv;
        KSerializer previousSerializer = (KSerializer) baseClassSerializers.get(concreteClass);
        Map $this$getOrPut$iv2 = this.polyBase2NamedSerializers;
        Object value$iv2 = $this$getOrPut$iv2.get(baseClass);
        if (value$iv2 == null) {
            answer$iv2 = new HashMap();
            $this$getOrPut$iv2.put(baseClass, answer$iv2);
        } else {
            answer$iv2 = value$iv2;
        }
        Map names = (Map) answer$iv2;
        if (allowOverwrite) {
        ...
        if (previousSerializer != null) {
            if (Intrinsics.areEqual((Object) previousSerializer, (Object) concreteSerializer)) {
                names.remove(previousSerializer.getDescriptor().getSerialName());
            } else {
        ...
        if (previousByName != null) {
            ...
            while (true) {
                ...
                obj = it.next();
                if (((Map.Entry) obj).getValue() == previousByName) {
                    z = true;
                    continue;
                } else {
                    z = false;
            ...
            throw new IllegalArgumentException("Multiple polymorphic serializers for base class '" + baseClass + "' have the same serial name '" + name + "': '" + concreteClass + "' and '" + ((Map.Entry) obj) + '\'');
        }
        baseClassSerializers.put(concreteClass, concreteSerializer);
        names.put(name, concreteSerializer);
    }
