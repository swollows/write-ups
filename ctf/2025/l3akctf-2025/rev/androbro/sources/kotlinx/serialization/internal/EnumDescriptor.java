...
public final class EnumDescriptor extends PluginGeneratedSerialDescriptor {
    ...
    public EnumDescriptor(String name, int elementsCount) {
        ...
        this.elementDescriptors$delegate = LazyKt.lazy(new EnumDescriptor$elementDescriptors$2(elementsCount, name, this));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SerialDescriptor) && ((SerialDescriptor) other).getKind() == SerialKind.ENUM.INSTANCE && Intrinsics.areEqual((Object) getSerialName(), (Object) ((SerialDescriptor) other).getSerialName()) && Intrinsics.areEqual((Object) Platform_commonKt.cachedSerialNames(this), (Object) Platform_commonKt.cachedSerialNames((SerialDescriptor) other))) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        for (String it : SerialDescriptorKt.getElementNames(this)) {
            int i = accumulator$iv$iv * 31;
            accumulator$iv$iv = i + (it != null ? it.hashCode() : 0);
        }
