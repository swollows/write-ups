...
public final class DelayKt {
    ...
    public static final Object m1786delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1787toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1787toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1612compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1716getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1631getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
