...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception) {
        ...
        try {
            ...
            e = Result.m281constructorimpl(((CopyableThrowable) exception).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e = Result.m281constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m287isFailureimpl(e)) {
            e = null;
        }
        return (Throwable) e;
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> $this$fieldsCountOrDefault, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            num = Result.m281constructorimpl(Integer.valueOf(fieldsCount$default($this$fieldsCountOrDefault, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m281constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(defaultValue);
        if (Result.m287isFailureimpl(num)) {
            num = valueOf;
        }
