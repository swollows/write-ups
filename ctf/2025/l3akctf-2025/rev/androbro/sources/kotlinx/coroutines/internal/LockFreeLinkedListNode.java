...
public class LockFreeLinkedListNode {
        ...
        public Object perform(Object affected2) {
            ...
            if (affected2 != null) {
                ...
                if (decision == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected2, this, next2.removed())) {
                ...
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, (LockFreeLinkedListNode) affected2, this, update);
                return null;
            }
    ...
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
        ...
        public final void complete(AtomicOp<?> op, Object failure) {
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, affectedNode, op, success ? updatedNext(affectedNode, originalNext2) : originalNext2) && success) {
