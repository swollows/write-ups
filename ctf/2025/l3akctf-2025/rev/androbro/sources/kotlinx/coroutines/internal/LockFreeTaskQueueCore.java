...
public final class LockFreeTaskQueueCore<E> {
    ...
    public final int addLast(E element) {
        ...
        while (true) {
            ...
            } else if (this.capacity < 1024 || ((tail - head) & MAX_CAPACITY_MASK) > (this.capacity >> 1)) {
                return 1;
            }
        }
        return 1;
    ...
    public final Object removeFirstOrNull() {
        ...
        while (true) {
            ...
            if (element == null) {
                ...
                int newHead2 = (head + 1) & MAX_CAPACITY_MASK;
                AtomicLongFieldUpdater atomicLongFieldUpdater = _state$FU;
                long updateHead = Companion.updateHead(state, newHead2);
                int newHead3 = newHead2;
                AtomicLongFieldUpdater atomicLongFieldUpdater2 = atomicLongFieldUpdater;
                Object element2 = element;
                $this$loop$iv = $this$loop$iv2;
                $i$f$loop = newHead;
                int head2 = head;
                int newHead4 = newHead3;
                int i = head$iv;
                int i2 = tail$iv;
                if (atomicLongFieldUpdater2.compareAndSet(this, state, updateHead)) {
                    ...
                    LockFreeTaskQueueCore cur = this;
                    while (true) {
                        LockFreeTaskQueueCore removeSlowPath = cur.removeSlowPath(head2, newHead4);
