...
public final class LintKt {
    ...
    private static final <T> Flow<T> m9catch(SharedFlow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt.m1catch($this$catch, action);
    }
