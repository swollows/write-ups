...
public final class NavType$Companion$FloatListType$1 extends CollectionNavType<List<? extends Float>> {
    ...
    public java.util.List<java.lang.Float> parseValue(java.lang.String r3, java.util.List<java.lang.Float> r4) {
        /*
            r2 = this;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean valueEquals(java.util.List<java.lang.Float> r7, java.util.List<java.lang.Float> r8) {
        /*
            r6 = this;
            r0 = 0
            r1 = 0
    ...
    public List<String> serializeAsValues(List<Float> value) {
        ...
        for (Number floatValue : $this$map$iv) {
            destination$iv$iv.add(String.valueOf(floatValue.floatValue()));
        }
