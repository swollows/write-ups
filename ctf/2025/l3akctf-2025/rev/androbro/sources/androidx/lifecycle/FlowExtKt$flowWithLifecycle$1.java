...
final class FlowExtKt$flowWithLifecycle$1 extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(flow, $this$callbackFlow2, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    Flow<T> flow = flow;
                    final ProducerScope<T> producerScope = $this$callbackFlow2;
                    this.label = 1;
                    if (flow.collect(new FlowCollector() {
                        public final Object emit(T it, Continuation<? super Unit> $completion) {
                            Object send = producerScope.send(it, $completion);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                final ProducerScope $this$callbackFlow2 = (ProducerScope) this.L$0;
        ...
        SendChannel.DefaultImpls.close$default($this$callbackFlow, (Throwable) null, 1, (Object) null);
        return Unit.INSTANCE;
    }
}
