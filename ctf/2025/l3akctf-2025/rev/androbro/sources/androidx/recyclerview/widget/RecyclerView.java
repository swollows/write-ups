...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public boolean scrollByInternal(int r21, int r22, android.view.MotionEvent r23) {
        /*
            r20 = this;
            r8 = r20
            r9 = r21
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        ...
                        if (this.mScrollState != i2) {
                            ...
                            if (scrollByInternal(i6, i, motionEvent)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                            }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedPreScroll(unconsumedX, unconsumedY, RecyclerView.this.mReusableIntPair, (int[]) null, 1)) {
