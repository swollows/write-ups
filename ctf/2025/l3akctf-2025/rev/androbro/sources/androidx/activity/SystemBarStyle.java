...
public final class SystemBarStyle {
    ...
    public static final class Companion {
        ...
        public final SystemBarStyle dark(int scrim) {
            return new SystemBarStyle(scrim, scrim, 2, SystemBarStyle$Companion$dark$1.INSTANCE, (DefaultConstructorMarker) null);
        }

        @JvmStatic
        public final SystemBarStyle light(int scrim, int darkScrim) {
            return new SystemBarStyle(scrim, darkScrim, 1, SystemBarStyle$Companion$light$1.INSTANCE, (DefaultConstructorMarker) null);
        }
    }
