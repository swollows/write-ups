...
final class ActivityRecreator {
    ...
    static boolean recreate(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                final Object token = tokenField.get(activity2);
                if (token == null || (activityThread = mainThreadField.get(activity2)) == null) {
                    return false;
                }
                application = activity.getApplication();
                final LifecycleCheckCallbacks callbacks2 = new LifecycleCheckCallbacks(activity2);
                ...
                try {
                    if (needsRelaunchCall()) {
                        ...
                        requestRelaunchActivityMethod.invoke(activityThread, new Object[]{token, null, null, 0, false, null, null, false, null});
                    } else {
                        callbacks = callbacks2;
                        activity.recreate();
                    }
