...
public final class MutableFloatSet extends FloatSet {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x00a3, code lost:
        if (((((~r10) << 6) & r10) & -9187201950435737472L) == 0) goto L_0x00b4;
     */
    ...
    public final boolean remove(float r25) {
        ...
        L_0x0069:
            ...
            int r15 = r15 + r6
            r10 = r15 & r5
            float[] r11 = r1.elements
            r11 = r11[r10]
            int r11 = (r11 > r25 ? 1 : (r11 == r25 ? 0 : -1))
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x00a0, code lost:
        if (((((~r10) << 6) & r10) & -9187201950435737472L) == 0) goto L_0x00ab;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x00a1, code lost:
        if (((((~r11) << 6) & r11) & -9187201950435737472L) == 0) goto L_0x0131;
     */
    ...
    private final int findAbsoluteInsertIndex(float r24) {
        ...
        L_0x0065:
            ...
            r16 = r11
            r18 = 0
            int r21 = java.lang.Long.numberOfTrailingZeros(r16)
            int r16 = r21 >> 3
            int r16 = r5 + r16
            r11 = r16 & r4
