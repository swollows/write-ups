...
public abstract class LongFloatMap {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            function2.invoke(Long.valueOf(k[index]), Float.valueOf(v[index]));
                        }
                        slot$iv >>= 8;
                        j$iv++;
                        i = 8;
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return longFloatMap.joinToString(charSequence, str, str2, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Long, ? super Float, ? extends CharSequence> transform) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            LongFloatMap longFloatMap = this_$iv;
            LongFloatMap longFloatMap2 = this_$iv$iv;
            int i6 = limit;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(obj instanceof LongFloatMap) || ((LongFloatMap) obj).getSize() != getSize()) {
            return false;
        }
        LongFloatMap this_$iv3 = this;
        int $i$f$forEach = 0;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        if (((slot$iv$iv & 255) < 128 ? 1 : 0) != 0) {
                            int index$iv = (i$iv$iv << 3) + j$iv$iv;
                            this_$iv2 = this_$iv3;
                            if (!(v$iv[index$iv] == ((LongFloatMap) obj).get(k$iv[index$iv]))) {
                                return false;
                            }
                        } else {
                            this_$iv2 = this_$iv3;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super Long, ? super Float, ? extends CharSequence> transform) {
        ...
        if (0 <= lastIndex$iv$iv$iv) {
            ...
            LongFloatMap longFloatMap = this_$iv$iv;
            int index$iv4 = limit;
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, Function2<? super Long, ? super Float, ? extends CharSequence> transform) {
        ...
        long[] k$iv$iv = this_$iv$iv.keys;
        float[] v$iv$iv = this_$iv$iv.values;
        LongFloatMap this_$iv$iv$iv = this_$iv$iv;
        long[] m$iv$iv$iv = this_$iv$iv$iv.metadata;
        LongFloatMap longFloatMap = this_$iv$iv$iv;
