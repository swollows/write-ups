...
public abstract class LongObjectMap<V> {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0091, code lost:
        if (((((~r9) << 6) & r9) & -9187201950435737472L) == 0) goto L_0x00a2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0093, code lost:
        r9 = -1;
     */
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            function2.invoke(Long.valueOf(k[index]), v[index]);
                        }
                        slot$iv >>= 8;
                        j$iv++;
                        i = 8;
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return longObjectMap.joinToString(charSequence, str, str2, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Long, ? super V, ? extends CharSequence> transform) {
        ...
        LongObjectMap longObjectMap = this_$iv;
        LongObjectMap longObjectMap2 = this_$iv$iv;
        int i5 = limit;
    ...
    public boolean equals(Object other) {
        ...
        if (!(obj instanceof LongObjectMap) || ((LongObjectMap) obj).getSize() != getSize()) {
            return false;
        }
        LongObjectMap this_$iv3 = this;
        int $i$f$forEach = 0;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv < bitCount$iv$iv) {
                        if (((slot$iv$iv & 255) < 128 ? 1 : 0) != 0) {
                            ...
                            if (value == null) {
                                int i2 = index$iv$iv;
                                if (((LongObjectMap) obj).get(key) != null || !((LongObjectMap) obj).containsKey(key)) {
                                    return false;
                                }
                            } else {
                                if (!Intrinsics.areEqual(value, ((LongObjectMap) obj).get(key))) {
                                    return false;
                                }
                            }
                        } else {
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super Long, ? super V, ? extends CharSequence> transform) {
        ...
        LongObjectMap longObjectMap = this_$iv$iv;
        int i7 = limit;
        int i8 = index$iv;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, Function2<? super Long, ? super V, ? extends CharSequence> transform) {
        ...
        long[] k$iv$iv = this_$iv$iv.keys;
        Object[] v$iv$iv = this_$iv$iv.values;
        LongObjectMap this_$iv$iv$iv = this_$iv$iv;
        long[] m$iv$iv$iv = this_$iv$iv$iv.metadata;
        LongObjectMap longObjectMap = this_$iv$iv$iv;
