...
public final class FlowExtKt {
    ...
    public static final <T> Flow<T> flowWithLifecycle(Flow<? extends T> $this$flowWithLifecycle, Lifecycle lifecycle, Lifecycle.State minActiveState) {
        Intrinsics.checkNotNullParameter($this$flowWithLifecycle, "<this>");
        Intrinsics.checkNotNullParameter(lifecycle, "lifecycle");
        Intrinsics.checkNotNullParameter(minActiveState, "minActiveState");
        return FlowKt.callbackFlow(new FlowExtKt$flowWithLifecycle$1(lifecycle, minActiveState, $this$flowWithLifecycle, (Continuation<? super FlowExtKt$flowWithLifecycle$1>) null));
    }
}
