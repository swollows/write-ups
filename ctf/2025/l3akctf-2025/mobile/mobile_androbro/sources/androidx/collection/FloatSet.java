...
public abstract class FloatSet {
    ...
    public final boolean all(Function1<? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                ...
                int bitCount$iv$iv = 8 - ((~(i$iv$iv - lastIndex$iv$iv)) >>> 31);
                for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv; j$iv$iv++) {
                    if (((slot$iv$iv2 & 255) < 128) && !function1.invoke(Float.valueOf(k$iv[(i$iv$iv << 3) + j$iv$iv])).booleanValue()) {
                        return false;
                    }
                    i = 8;
                    slot$iv$iv2 >>= 8;
        ...
        if (0 <= lastIndex$iv$iv) {
            while (true) {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    int bitCount$iv$iv = 8 - ((~(i$iv$iv - lastIndex$iv$iv)) >>> 31);
                    for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv; j$iv$iv++) {
                        if (((255 & slot$iv$iv) < 128) && function1.invoke(Float.valueOf(k$iv[(i$iv$iv << 3) + j$iv$iv])).booleanValue()) {
                            count2++;
                        }
                        i = 8;
                        slot$iv$iv >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(FloatSet floatSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return floatSet.joinToString(charSequence, str, str2, i3, charSequence5);
        }
    ...
    public boolean equals(java.lang.Object r22) {
        ...
        L_0x005b:
            ...
            r20 = 0
            r4 = r1
            androidx.collection.FloatSet r4 = (androidx.collection.FloatSet) r4
