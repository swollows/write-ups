...
public abstract class ObjectFloatMap<K> {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            function2.invoke(k[index], Float.valueOf(v[index]));
                        }
                        slot$iv >>= 8;
                        j$iv++;
                        i = 8;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return objectFloatMap.joinToString(charSequence, str, str2, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            ObjectFloatMap objectFloatMap = this_$iv;
            ObjectFloatMap objectFloatMap2 = this_$iv$iv;
            int i6 = limit;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(obj instanceof ObjectFloatMap) || ((ObjectFloatMap) obj).getSize() != getSize()) {
            return false;
        }
        ObjectFloatMap o = (ObjectFloatMap) obj;
        ObjectFloatMap this_$iv = this;
        Object[] k$iv = this_$iv.keys;
        float[] v$iv = this_$iv.values;
        long[] m$iv$iv = this_$iv.metadata;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        ObjectFloatMap objectFloatMap = this_$iv$iv;
        int i7 = limit;
        int i8 = index$iv;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        Object[] k$iv$iv = this_$iv$iv.keys;
        float[] v$iv$iv = this_$iv$iv.values;
        ObjectFloatMap this_$iv$iv$iv = this_$iv$iv;
        long[] m$iv$iv$iv = this_$iv$iv$iv.metadata;
        ObjectFloatMap objectFloatMap = this_$iv$iv$iv;
