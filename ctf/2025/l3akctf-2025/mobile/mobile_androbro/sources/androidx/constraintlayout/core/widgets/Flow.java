...
public class Flow extends VirtualLayout {
    ...
    public void measure(int r24, int r25, int r26, int r27) {
        ...
        L_0x0042:
            ...
            int r0 = r6.mHorizontalStyle
            if (r0 != r1) goto L_0x004d
            r6.mHorizontalStyle = r11
        L_0x004d:
            int r0 = r6.mVerticalStyle
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i != 0) {
            ...
            if (nbMatchConstraintsWidgets4 <= 0 || !needInternalMeasure) {
                ...
                while (i6 < listCount) {
                    ...
                    if (orientation == 0) {
                        ...
                        current.measureMatchConstraints(i2 - current.getWidth());
                    } else {
                        nbMatchConstraintsWidgets = nbMatchConstraintsWidgets4;
                        current.measureMatchConstraints(i2 - current.getHeight());
                    }
                    i6++;
            ...
            while (i8 < listCount) {
                ...
                if (orientation == 0) {
                    if (i8 < listCount - 1) {
                        bottom = this.mChainList.get(i8 + 1).mBiggest.mTop;
                        paddingBottom2 = 0;
                    } else {
                        bottom = this.mBottom;
                    ...
                    ConstraintAnchor top2 = current2.mBiggest.mBottom;
                    paddingTop2 = 0;
                    ...
                    if (i8 < listCount - 1) {
                        right = this.mChainList.get(i8 + 1).mBiggest.mLeft;
                        paddingRight2 = 0;
                    } else {
                        right = this.mRight;
                    ...
                    left3 = current2.mBiggest.mRight;
                    paddingLeft = 0;
            ...
            while (i6 < cols) {
                ...
                while (j < rows) {
                    ...
                    if (index < constraintWidgetArr.length && (widget = constraintWidgetArr[index]) != null) {
                        ...
                        if (this.mAlignedBiggestElementsInCols[i6] == null || this.mAlignedBiggestElementsInCols[i6].getWidth() < w3) {
