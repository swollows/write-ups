...
class FontRequestWorker {
    ...
    static android.graphics.Typeface requestFontAsync(final android.content.Context r7, final androidx.core.provider.FontRequest r8, final int r9, java.util.concurrent.Executor r10, final androidx.core.provider.CallbackWithHandler r11) {
        ...
        L_0x0017:
            ...
            monitor-enter(r3)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.util.Consumer<androidx.core.provider.FontRequestWorker$TypefaceResult>>> r4 = PENDING_REPLIES     // Catch:{ all -> 0x0053 }
            java.lang.Object r4 = r4.get(r0)     // Catch:{ all -> 0x0053 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0053 }
            r5 = 0
            if (r4 == 0) goto L_0x002f
            r4.add(r2)     // Catch:{ all -> 0x0053 }
            monitor-exit(r3)     // Catch:{ all -> 0x0053 }
            return r5
        L_0x002f:
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0053 }
            r6.<init>()     // Catch:{ all -> 0x0053 }
            r4 = r6
            r4.add(r2)     // Catch:{ all -> 0x0053 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.util.Consumer<androidx.core.provider.FontRequestWorker$TypefaceResult>>> r6 = PENDING_REPLIES     // Catch:{ all -> 0x0053 }
            r6.put(r0, r4)     // Catch:{ all -> 0x0053 }
            monitor-exit(r3)     // Catch:{ all -> 0x0053 }
