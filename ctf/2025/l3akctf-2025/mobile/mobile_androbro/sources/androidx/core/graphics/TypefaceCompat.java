    ...
    public static class ResourcesCallbackAdapter extends FontsContractCompat.FontRequestCallback {
        ...
        public void onTypefaceRetrieved(Typeface typeface) {
            if (this.mFontCallback != null) {
                this.mFontCallback.m109lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(typeface);
            }
        }

        public void onTypefaceRequestFailed(int reason) {
            if (this.mFontCallback != null) {
                this.mFontCallback.m108lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(reason);
            }
        }
    }
}
