...
final class FragmentManagerViewModel extends ViewModel {
    ...
    /* access modifiers changed from: package-private */
    public void clearNonConfigState(Fragment f, boolean destroyChildNonConfig) {
        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    /* access modifiers changed from: package-private */
    public void clearNonConfigState(String who, boolean destroyChildNonConfig) {
        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    private void clearNonConfigStateInternal(String who, boolean destroyChildNonConfig) {
        ...
        if (childNonConfig != null) {
            if (destroyChildNonConfig) {
                ...
                while (it.hasNext()) {
                    childNonConfig.clearNonConfigState(it.next(), true);
                }
            }
