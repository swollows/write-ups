...
public final class NavType$Companion$BoolListType$1 extends CollectionNavType<List<? extends Boolean>> {
    ...
    public java.util.List<java.lang.Boolean> parseValue(java.lang.String r3, java.util.List<java.lang.Boolean> r4) {
        /*
            r2 = this;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean valueEquals(java.util.List<java.lang.Boolean> r7, java.util.List<java.lang.Boolean> r8) {
        /*
            r6 = this;
            r0 = 0
            r1 = 0
    ...
    public List<String> serializeAsValues(List<Boolean> value) {
        ...
        Iterable<Boolean> $this$map$iv = value;
