...
final class NavDestination$route$missingRequiredArguments$1 extends Lambda implements Function1<String, Boolean> {
    final /* synthetic */ NavDeepLink $tempDeepLink;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NavDestination$route$missingRequiredArguments$1(NavDeepLink navDeepLink) {
        super(1);
