...
public final class NavControllerKt {
    public static final boolean navigateUp(NavController $this$navigateUp, Openable drawerLayout) {
        ...
        return NavigationUI.navigateUp($this$navigateUp, new AppBarConfiguration.Builder($this$navigateUp.getGraph()).setOpenableLayout(drawerLayout).setFallbackOnNavigateUpListener(new AppBarConfigurationKt$sam$i$androidx_navigation_ui_AppBarConfiguration_OnNavigateUpListener$0(AppBarConfigurationKt$AppBarConfiguration$1.INSTANCE)).build());
    }
