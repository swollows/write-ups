...
public final class ActivityNavigatorDestinationBuilderKt {
    ...
    public static /* synthetic */ void activity$default(NavGraphBuilder $this$activity_u24default, Map typeMap, Function1 builder, int i, Object obj) {
        ...
        ActivityNavigatorDestinationBuilder activityNavigatorDestinationBuilder = new ActivityNavigatorDestinationBuilder((ActivityNavigator) $this$activity_u24default.getProvider().getNavigator(ActivityNavigator.class), Reflection.getOrCreateKotlinClass(Object.class), typeMap);
        builder.invoke(activityNavigatorDestinationBuilder);
    ...
    public static final /* synthetic */ <T> void activity(NavGraphBuilder $this$activity, Map<KType, NavType<?>> typeMap, Function1<? super ActivityNavigatorDestinationBuilder, Unit> builder) {
        ...
        Intrinsics.checkNotNullParameter(builder, "builder");
        Intrinsics.reifiedOperationMarker(4, "T");
        ActivityNavigatorDestinationBuilder activityNavigatorDestinationBuilder = new ActivityNavigatorDestinationBuilder((ActivityNavigator) $this$activity.getProvider().getNavigator(ActivityNavigator.class), Reflection.getOrCreateKotlinClass(Object.class), typeMap);
        builder.invoke(activityNavigatorDestinationBuilder);
        $this$activity.destination(activityNavigatorDestinationBuilder);
    }
}
