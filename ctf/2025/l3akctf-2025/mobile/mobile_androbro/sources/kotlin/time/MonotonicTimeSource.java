...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1747markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1759constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1746elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1745differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1744adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1759constructorimpl(LongSaturatedMathKt.m1742saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
