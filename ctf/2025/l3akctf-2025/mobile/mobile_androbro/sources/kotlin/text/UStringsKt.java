...
public final class UStringsKt {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m349unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m612unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m507unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m428unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m376constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m293boximpl(UByte.m299constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m428unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m376constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m556boximpl(UShort.m562constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m376constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m376constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m376constructorimpl(UInt.m376constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, beforeAdding ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m370boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m455constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m455constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m455constructorimpl(ULong.m455constructorimpl(((long) UInt.m376constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m449boximpl(result);
    }
}
