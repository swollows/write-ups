...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m12boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m13constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m15equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m21unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m15equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m18hashCodeimpl(this.holder);
    }

    public String toString() {
        return m20toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m14constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m13constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM  reason: not valid java name */
    public static final Object m19plusFjFbRPM(Object arg0, E element) {
        if (DebugKt.getASSERTIONS_ENABLED() && (element instanceof List)) {
            throw new AssertionError();
        } else if (arg0 == null) {
            return m13constructorimpl(element);
        } else {
            if (!(arg0 instanceof ArrayList)) {
                ArrayList list = new ArrayList(4);
                list.add(arg0);
                list.add(element);
                return m13constructorimpl(list);
            } else if (arg0 != null) {
                ((ArrayList) arg0).add(element);
                return m13constructorimpl(arg0);
            } else {
    ...
    public static final void m17forEachReversedimpl(Object arg0, Function1<? super E, Unit> action) {
        if (arg0 != null) {
            if (!(arg0 instanceof ArrayList)) {
                action.invoke(arg0);
            } else if (arg0 != null) {
