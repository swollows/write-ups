...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    public Object pollInternal() {
        ...
        try {
            ...
            if (replacement != AbstractChannelKt.POLL_FAILED && !(replacement instanceof Closed)) {
                this.size = size2;
                this.buffer[(this.head + size2) % this.buffer.length] = replacement;
            }
            this.head = (this.head + 1) % this.buffer.length;
            Unit unit = Unit.INSTANCE;
            lock2.unlock();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0062, code lost:
        if (r10 != kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()) goto L_0x0071;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0073, code lost:
        if ((r10 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x0079;
     */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r15) {
        /*
            ...
            r5.lock()
            r6 = 0
            int r7 = r14.size     // Catch:{ all -> 0x00df }
            if (r7 != 0) goto L_0x001d
            kotlinx.coroutines.channels.Closed r8 = r14.getClosedForSend()     // Catch:{ all -> 0x00df }
            if (r8 != 0) goto L_0x0019
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00df }
        L_0x0019:
            r5.unlock()
            return r8
        L_0x001d:
            java.lang.Object[] r8 = r14.buffer     // Catch:{ all -> 0x00df }
            int r9 = r14.head     // Catch:{ all -> 0x00df }
            r8 = r8[r9]     // Catch:{ all -> 0x00df }
            r2 = r8
            java.lang.Object[] r8 = r14.buffer     // Catch:{ all -> 0x00df }
            int r9 = r14.head     // Catch:{ all -> 0x00df }
            r10 = 0
            r8[r9] = r10     // Catch:{ all -> 0x00df }
            int r8 = r7 + -1
            r14.size = r8     // Catch:{ all -> 0x00df }
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00df }
            int r9 = r14.capacity     // Catch:{ all -> 0x00df }
            if (r7 != r9) goto L_0x0096
        L_0x0035:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r9 = r14.describeTryPoll()     // Catch:{ all -> 0x00df }
            r10 = r9
            kotlinx.coroutines.internal.AtomicDesc r10 = (kotlinx.coroutines.internal.AtomicDesc) r10     // Catch:{ all -> 0x00df }
            java.lang.Object r10 = r15.performAtomicTrySelect(r10)     // Catch:{ all -> 0x00df }
            if (r10 != 0) goto L_0x0056
            java.lang.Object r11 = r9.getResult()     // Catch:{ all -> 0x00df }
            r0 = r11
            r1 = 1
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00df }
            r11 = r0
            kotlinx.coroutines.channels.Send r11 = (kotlinx.coroutines.channels.Send) r11     // Catch:{ all -> 0x00df }
            java.lang.Object r11 = r11.getPollResult()     // Catch:{ all -> 0x00df }
            r8 = r11
            goto L_0x0096
        L_0x0056:
            kotlinx.coroutines.internal.Symbol r11 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00df }
            if (r10 == r11) goto L_0x0096
            java.lang.Object r11 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00df }
            if (r10 == r11) goto L_0x0035
            java.lang.Object r11 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00df }
            if (r10 != r11) goto L_0x0071
            r14.size = r7     // Catch:{ all -> 0x00df }
            java.lang.Object[] r11 = r14.buffer     // Catch:{ all -> 0x00df }
            int r12 = r14.head     // Catch:{ all -> 0x00df }
            r11[r12] = r2     // Catch:{ all -> 0x00df }
            r5.unlock()
            return r10
        L_0x0071:
            boolean r11 = r10 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00df }
        ...
        L_0x0079:
            ...
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ all -> 0x00df }
            java.lang.StringBuilder r12 = r12.append(r10)     // Catch:{ all -> 0x00df }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x00df }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x00df }
            r11.<init>(r12)     // Catch:{ all -> 0x00df }
            throw r11     // Catch:{ all -> 0x00df }
        L_0x0096:
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00df }
            if (r8 == r9) goto L_0x00ac
            boolean r9 = r8 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00df }
            if (r9 != 0) goto L_0x00ac
            r14.size = r7     // Catch:{ all -> 0x00df }
            java.lang.Object[] r9 = r14.buffer     // Catch:{ all -> 0x00df }
            int r10 = r14.head     // Catch:{ all -> 0x00df }
            int r10 = r10 + r7
            java.lang.Object[] r11 = r14.buffer     // Catch:{ all -> 0x00df }
            int r11 = r11.length     // Catch:{ all -> 0x00df }
            int r10 = r10 % r11
            r9[r10] = r8     // Catch:{ all -> 0x00df }
            goto L_0x00c2
        L_0x00ac:
            boolean r9 = r15.trySelect()     // Catch:{ all -> 0x00df }
            if (r9 != 0) goto L_0x00c2
            r14.size = r7     // Catch:{ all -> 0x00df }
            java.lang.Object[] r9 = r14.buffer     // Catch:{ all -> 0x00df }
            int r10 = r14.head     // Catch:{ all -> 0x00df }
            r9[r10] = r2     // Catch:{ all -> 0x00df }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00df }
            r5.unlock()
            return r9
        L_0x00c2:
            int r9 = r14.head     // Catch:{ all -> 0x00df }
            int r9 = r9 + 1
            java.lang.Object[] r10 = r14.buffer     // Catch:{ all -> 0x00df }
            int r10 = r10.length     // Catch:{ all -> 0x00df }
            int r9 = r9 % r10
            r14.head = r9     // Catch:{ all -> 0x00df }
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00df }
            r5.unlock()
