...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.m1825tryReceivePtdJZtk();
            if (ChannelResult.m1815isSuccessimpl(result)) {
                return ChannelResult.m1811getOrThrowimpl(result);
            }
            Throwable r1 = ChannelResult.m1809exceptionOrNullimpl(result);
            if (r1 == null) {
                return null;
            }
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L_0x002d:
                ...
                java.lang.Object r3 = r3.m1817unboximpl()
                goto L_0x0045
            L_0x0038:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.m1824receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L_0x0045
                return r1
            L_0x0045:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1810getOrNullimpl(r3)
                return r3
            */
