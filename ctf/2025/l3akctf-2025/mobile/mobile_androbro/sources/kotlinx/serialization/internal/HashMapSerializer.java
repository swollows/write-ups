...
public final class HashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, HashMap<K, V>> {
    ...
    public int collectionSize(Map<K, ? extends V> $this$collectionSize) {
        Intrinsics.checkNotNullParameter($this$collectionSize, "<this>");
        return $this$collectionSize.size();
    }

    /* access modifiers changed from: protected */
    public Iterator<Map.Entry<K, V>> collectionIterator(Map<K, ? extends V> $this$collectionIterator) {
    ...
    /* access modifiers changed from: protected */
    public int builderSize(HashMap<K, V> $this$builderSize) {
        Intrinsics.checkNotNullParameter($this$builderSize, "<this>");
        return $this$builderSize.size() * 2;
    }

    /* access modifiers changed from: protected */
    public Map<K, V> toResult(HashMap<K, V> $this$toResult) {
        Intrinsics.checkNotNullParameter($this$toResult, "<this>");
        return $this$toResult;
    }

    /* access modifiers changed from: protected */
    public HashMap<K, V> toBuilder(Map<K, ? extends V> $this$toBuilder) {
        Intrinsics.checkNotNullParameter($this$toBuilder, "<this>");
        HashMap<K, V> hashMap = $this$toBuilder instanceof HashMap ? (HashMap) $this$toBuilder : null;
        return hashMap == null ? new HashMap<>($this$toBuilder) : hashMap;
    }

    /* access modifiers changed from: protected */
    public void checkCapacity(HashMap<K, V> $this$checkCapacity, int size) {
        Intrinsics.checkNotNullParameter($this$checkCapacity, "<this>");
    }

    /* access modifiers changed from: protected */
    public void insertKeyValuePair(HashMap<K, V> $this$insertKeyValuePair, int index, K key, V value) {
