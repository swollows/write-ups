...
public final class SerialDescriptorForNullable implements SerialDescriptor, CachedNames {
    ...
    private final String serialName = (this.original.getSerialName() + '?');
    ...
    public SerialDescriptorForNullable(SerialDescriptor original2) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SerialDescriptorForNullable) && Intrinsics.areEqual((Object) this.original, (Object) ((SerialDescriptorForNullable) other).original)) {
            return true;
        }
        return false;
    }
