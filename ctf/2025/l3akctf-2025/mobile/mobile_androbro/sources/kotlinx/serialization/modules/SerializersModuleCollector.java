...
public interface SerializersModuleCollector {
    ...
    public static final class DefaultImpls {
        public static <T> void contextual(SerializersModuleCollector $this, KClass<T> kClass, KSerializer<T> serializer) {
            Intrinsics.checkNotNullParameter(kClass, "kClass");
            Intrinsics.checkNotNullParameter(serializer, "serializer");
            $this.contextual(kClass, (Function1<? super List<? extends KSerializer<?>>, ? extends KSerializer<?>>) new SerializersModuleCollector$contextual$1(serializer));
        }
