...
public final class ULongArraySerializer extends PrimitiveArraySerializer<ULong, ULongArray, ULongArrayBuilder> implements KSerializer<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object $this$collectionSize) {
        return m58collectionSizeQwZRm1k(((ULongArray) $this$collectionSize).m524unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return ULongArray.m508boximpl(m59emptyY2RjT0g());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object $this$toBuilder) {
        return m60toBuilderQwZRm1k(((ULongArray) $this$toBuilder).m524unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder encoder, Object content, int size) {
        m61writeContent0q3Fkuo(encoder, ((ULongArray) content).m524unboximpl(), size);
    }
    ...
    public int m58collectionSizeQwZRm1k(long[] $this$collectionSize_u2dQwZRm1k) {
        Intrinsics.checkNotNullParameter($this$collectionSize_u2dQwZRm1k, "$this$collectionSize");
        return ULongArray.m516getSizeimpl($this$collectionSize_u2dQwZRm1k);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-QwZRm1k  reason: not valid java name */
    public ULongArrayBuilder m60toBuilderQwZRm1k(long[] $this$toBuilder_u2dQwZRm1k) {
    ...
    public long[] m59emptyY2RjT0g() {
        return ULongArray.m509constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder decoder, int index, ULongArrayBuilder builder, boolean checkIndex) {
        ...
        builder.m56appendVKZWuLQ$kotlinx_serialization_core(ULong.m455constructorimpl(decoder.decodeInlineElement(getDescriptor(), index).decodeLong()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-0q3Fkuo  reason: not valid java name */
    public void m61writeContent0q3Fkuo(CompositeEncoder encoder, long[] content, int size) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(content, "content");
        for (int i = 0; i < size; i++) {
            encoder.encodeInlineElement(getDescriptor(), i).encodeLong(ULongArray.m515getsVKNKU(content, i));
        }
    }
}
