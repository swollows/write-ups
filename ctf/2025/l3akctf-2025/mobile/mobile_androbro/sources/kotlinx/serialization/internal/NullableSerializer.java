...
public final class NullableSerializer<T> implements KSerializer<T> {
    private final SerialDescriptor descriptor = new SerialDescriptorForNullable(this.serializer.getDescriptor());
    private final KSerializer<T> serializer;

    public NullableSerializer(KSerializer<T> serializer2) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual((Object) this.serializer, (Object) ((NullableSerializer) other).serializer)) {
            return false;
        }
        return true;
    }
