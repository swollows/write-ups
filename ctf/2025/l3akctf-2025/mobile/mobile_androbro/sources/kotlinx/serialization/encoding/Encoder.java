...
public interface Encoder {
    ...
    public static final class DefaultImpls {
        ...
        public static <T> void encodeSerializableValue(Encoder $this, SerializationStrategy<? super T> serializer, T value) {
            Intrinsics.checkNotNullParameter(serializer, "serializer");
            serializer.serialize($this, value);
        }

        @ExperimentalSerializationApi
        public static <T> void encodeNullableSerializableValue(Encoder $this, SerializationStrategy<? super T> serializer, T value) {
            Intrinsics.checkNotNullParameter(serializer, "serializer");
