...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m556boximpl(m70deserializeBwKQO78(decoder));
    }

    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m71serializei8woANY(encoder, ((UShort) value).m612unboximpl());
    }
    ...
    public void m71serializei8woANY(Encoder encoder, short value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeShort(value);
    }

    /* renamed from: deserialize-BwKQO78  reason: not valid java name */
    public short m70deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m562constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}
