...
final class ClassValueCache<T> implements SerializerCache<T> {
    ...
    public ClassValueCache(Function1<? super KClass<?>, ? extends KSerializer<T>> compute2) {
    ...
    public KSerializer<T> get(KClass<Object> key) {
        ...
        if (t == null) {
            t = ref$iv.getOrSetWithLock(new ClassValueCache$get$$inlined$getOrSet$1(this, key));
        }
