...
public final class UIntArraySerializer extends PrimitiveArraySerializer<UInt, UIntArray, UIntArrayBuilder> implements KSerializer<UIntArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object $this$collectionSize) {
        return m50collectionSizeajY9A(((UIntArray) $this$collectionSize).m445unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UIntArray.m429boximpl(m51emptyhP7Qyg());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object $this$toBuilder) {
        return m52toBuilderajY9A(((UIntArray) $this$toBuilder).m445unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder encoder, Object content, int size) {
        m53writeContentCPlH8fI(encoder, ((UIntArray) content).m445unboximpl(), size);
    }
    ...
    public int m50collectionSizeajY9A(int[] $this$collectionSize_u2d_u2dajY_u2d9A) {
        Intrinsics.checkNotNullParameter($this$collectionSize_u2d_u2dajY_u2d9A, "$this$collectionSize");
        return UIntArray.m437getSizeimpl($this$collectionSize_u2d_u2dajY_u2d9A);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder--ajY-9A  reason: not valid java name */
    public UIntArrayBuilder m52toBuilderajY9A(int[] $this$toBuilder_u2d_u2dajY_u2d9A) {
    ...
    public int[] m51emptyhP7Qyg() {
        return UIntArray.m430constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder decoder, int index, UIntArrayBuilder builder, boolean checkIndex) {
        ...
        builder.m48appendWZ4Q5Ns$kotlinx_serialization_core(UInt.m376constructorimpl(decoder.decodeInlineElement(getDescriptor(), index).decodeInt()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-CPlH8fI  reason: not valid java name */
    public void m53writeContentCPlH8fI(CompositeEncoder encoder, int[] content, int size) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(content, "content");
        for (int i = 0; i < size; i++) {
            encoder.encodeInlineElement(getDescriptor(), i).encodeInt(UIntArray.m436getpVg5ArA(content, i));
        }
    }
}
