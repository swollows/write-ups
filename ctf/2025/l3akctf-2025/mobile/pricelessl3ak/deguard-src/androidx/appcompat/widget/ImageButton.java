  ...
  extends android.widget.ImageButton
{
  ...
  public final RoundedImageView mDrawable;
  public boolean r = false;
  
  public ImageButton(android.content.Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    return (!(mDrawable.mView.getBackground() instanceof RippleDrawable)) && (super.hasOverlappingRendering());
  }
  ...
  {
    RoundedImageView localRoundedImageView = mDrawable;
    if ((localRoundedImageView != null) && (paramDrawable != null) && (!r)) {
