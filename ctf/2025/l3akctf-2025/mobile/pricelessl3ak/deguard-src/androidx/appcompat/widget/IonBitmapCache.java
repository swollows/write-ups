...
public abstract class IonBitmapCache
{
  public static StaticLayout get(CharSequence paramCharSequence, Layout.Alignment paramAlignment, int paramInt1, int paramInt2, TextView paramTextView, TextPaint paramTextPaint, CharArray paramCharArray)
  {
    ...
    try
    {
      paramCharArray.add(paramCharSequence, paramTextView);
    }
