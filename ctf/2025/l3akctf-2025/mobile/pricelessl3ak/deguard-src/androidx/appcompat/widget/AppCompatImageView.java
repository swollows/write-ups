...
public final class AppCompatImageView
  extends CheckBox
{
  ...
  public AppCompatImageView(android.content.Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet, 2130903114);
    ThemeUtils.a(this, getContext());
    paramContext = new AppCompatCompoundButtonHelper(this);
    mCompoundButtonHelper = paramContext;
    paramContext.loadFromAttributes(paramAttributeSet, 2130903114);
    ...
    paramContext.init(paramAttributeSet, 2130903114);
    getEmojiTextViewHelper().a(paramAttributeSet, 2130903114);
  }
