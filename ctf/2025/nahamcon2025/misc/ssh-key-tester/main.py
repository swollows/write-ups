...
def run():
    ...
    userid = "user%d" % random.randint(0, 1000) # user0 ~ user999 중 1개 랜덤 선택
    os.system("useradd %s && mkdir -p /home/%s/.ssh" % (userid, userid)) # useradd userXXX && mkdir -p /home/userXXX/.ssh
