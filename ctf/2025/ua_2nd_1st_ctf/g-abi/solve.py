...
# 문제에서 사용하는 각종 정보 추출
MAIN_URL = "http://host1.dreamhack.games:8750"
...
BASE_DIR = os.path.dirname(current_file) + "/abi"
CONTRACT_PATH = "/src/ChallengeAttack.sol"

command = [
    "forge", "create",
    "--rpc-url", RPC_URL,
    "--private-key", USER_PRIV_KEY,
    BASE_DIR + CONTRACT_PATH + ":ChallengeAttack",
    "--via-ir",
    "--broadcast",
    "--constructor-args",
    CONTRACT_ADDRESS
