...
# 문제에서 사용하는 각종 정보 추출
MAIN_URL = "http://host1.dreamhack.games:15512"
...
BASE_DIR = os.path.dirname(current_file) + "/basicevm"
CONTRACT_PATH = "/src/BasicEVMAttack.sol"

command = [
    "forge", "create",
    "--rpc-url", RPC_URL,
    "--private-key", USER_PRIV_KEY,
    BASE_DIR + CONTRACT_PATH + ":BasicEVMAttack",
    "--broadcast",
    "--constructor-args",
    CONTRACT_ADDRESS
]
...
tx = contract.functions.setSolver(ATTACKER_ADDRESS).build_transaction(data)
...
tx = contract.functions.isSolved().build_transaction(data)
