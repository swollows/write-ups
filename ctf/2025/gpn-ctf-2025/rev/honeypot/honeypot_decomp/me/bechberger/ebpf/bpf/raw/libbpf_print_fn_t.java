...
public class libbpf_print_fn_t {
    private static final FunctionDescriptor $DESC = FunctionDescriptor.of((MemoryLayout)Lib.C_INT, (MemoryLayout[])new MemoryLayout[]{Lib.C_INT, Lib.C_POINTER, Lib.C_POINTER});
    ...
    public static int invoke(MemorySegment funcPtr, int level, MemorySegment _x1, MemorySegment ap) {
        try {
            return DOWN$MH.invokeExact(funcPtr, level, _x1, ap);
        } catch (Throwable ex$) {
    ...
    public static interface Function {
        public int apply(int var1, MemorySegment var2, MemorySegment var3);
    }
}
