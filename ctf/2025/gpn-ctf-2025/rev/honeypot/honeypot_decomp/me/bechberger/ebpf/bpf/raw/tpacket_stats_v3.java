...
public class tpacket_stats_v3 {
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout((MemoryLayout[])new MemoryLayout[]{Lib.C_INT.withName("tp_packets"), Lib.C_INT.withName("tp_drops"), Lib.C_INT.withName("tp_freeze_q_cnt")}).withName("tpacket_stats_v3");
    ...
    private static final ValueLayout.OfInt tp_freeze_q_cnt$LAYOUT = (ValueLayout.OfInt)$LAYOUT.select(new MemoryLayout.PathElement[]{MemoryLayout.PathElement.groupElement((String)"tp_freeze_q_cnt")});
    private static final long tp_freeze_q_cnt$OFFSET = 8L;
    ...
    public static final ValueLayout.OfInt tp_freeze_q_cnt$layout() {
    ...
    public static int tp_freeze_q_cnt(MemorySegment struct) {
        return struct.get(tp_freeze_q_cnt$LAYOUT, 8L);
    }

    public static void tp_freeze_q_cnt(MemorySegment struct, int fieldValue) {
        struct.set(tp_freeze_q_cnt$LAYOUT, 8L, fieldValue);
    }

    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(tpacket_stats_v3.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return tpacket_stats_v3.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)tpacket_stats_v3.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)tpacket_stats_v3.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return tpacket_stats_v3.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(tpacket_stats_v3.layout().byteSize() * elementCount, arena, cleanup);
    }
}
