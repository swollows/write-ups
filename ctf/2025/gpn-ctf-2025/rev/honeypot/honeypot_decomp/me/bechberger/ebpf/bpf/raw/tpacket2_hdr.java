...
public class tpacket2_hdr {
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout((MemoryLayout[])new MemoryLayout[]{Lib.C_INT.withName("tp_status"), Lib.C_INT.withName("tp_len"), Lib.C_INT.withName("tp_snaplen"), Lib.C_SHORT.withName("tp_mac"), Lib.C_SHORT.withName("tp_net"), Lib.C_INT.withName("tp_sec"), Lib.C_INT.withName("tp_nsec"), Lib.C_SHORT.withName("tp_vlan_tci"), Lib.C_SHORT.withName("tp_vlan_tpid"), MemoryLayout.sequenceLayout((long)4L, (MemoryLayout)Lib.C_CHAR).withName("tp_padding")}).withName("tpacket2_hdr");
    ...
    private static final long tp_sec$OFFSET = 16L;
    ...
    private static final long tp_nsec$OFFSET = 20L;
    ...
    private static final long tp_vlan_tci$OFFSET = 24L;
    ...
    private static final long tp_vlan_tpid$OFFSET = 26L;
    ...
    private static final long tp_padding$OFFSET = 28L;
    private static long[] tp_padding$DIMS = new long[]{4L};
    ...
    public static int tp_sec(MemorySegment struct) {
        return struct.get(tp_sec$LAYOUT, 16L);
    }

    public static void tp_sec(MemorySegment struct, int fieldValue) {
        struct.set(tp_sec$LAYOUT, 16L, fieldValue);
    }
    ...
    public static int tp_nsec(MemorySegment struct) {
        return struct.get(tp_nsec$LAYOUT, 20L);
    }

    public static void tp_nsec(MemorySegment struct, int fieldValue) {
        struct.set(tp_nsec$LAYOUT, 20L, fieldValue);
    }
    ...
    public static short tp_vlan_tci(MemorySegment struct) {
        return struct.get(tp_vlan_tci$LAYOUT, 24L);
    }

    public static void tp_vlan_tci(MemorySegment struct, short fieldValue) {
        struct.set(tp_vlan_tci$LAYOUT, 24L, fieldValue);
    }
    ...
    public static short tp_vlan_tpid(MemorySegment struct) {
        return struct.get(tp_vlan_tpid$LAYOUT, 26L);
    }

    public static void tp_vlan_tpid(MemorySegment struct, short fieldValue) {
        struct.set(tp_vlan_tpid$LAYOUT, 26L, fieldValue);
    }
    ...
    public static MemorySegment tp_padding(MemorySegment struct) {
        return struct.asSlice(28L, tp_padding$LAYOUT.byteSize());
    }

    public static void tp_padding(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy((MemorySegment)fieldValue, (long)0L, (MemorySegment)struct, (long)28L, (long)tp_padding$LAYOUT.byteSize());
    }
    ...
    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(tpacket2_hdr.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return tpacket2_hdr.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)tpacket2_hdr.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)tpacket2_hdr.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return tpacket2_hdr.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(tpacket2_hdr.layout().byteSize() * elementCount, arena, cleanup);
    }
}
