...
public class bpf_refcount {
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout((MemoryLayout[])new MemoryLayout[]{MemoryLayout.sequenceLayout((long)1L, (MemoryLayout)Lib.C_INT).withName("__opaque")}).withName("bpf_refcount");
    ...
    private static long[] __opaque$DIMS = new long[]{1L};
    ...
    public static int __opaque(MemorySegment struct, long index0) {
        return __opaque$ELEM_HANDLE.get(struct, 0L, index0);
    }

    public static void __opaque(MemorySegment struct, long index0, int fieldValue) {
        __opaque$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }

    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(bpf_refcount.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return bpf_refcount.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)bpf_refcount.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)bpf_refcount.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return bpf_refcount.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(bpf_refcount.layout().byteSize() * elementCount, arena, cleanup);
    }
}
