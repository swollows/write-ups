...
import me.bechberger.ebpf.bpf.raw.__pthread_rwlock_arch_t;

public class pthread_rwlock_t {
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout((MemoryLayout[])new MemoryLayout[]{__pthread_rwlock_arch_t.layout().withName("__data"), MemoryLayout.sequenceLayout((long)56L, (MemoryLayout)Lib.C_CHAR).withName("__size"), Lib.C_LONG.withName("__align")}).withName("$anon$86:9");
    private static final GroupLayout __data$LAYOUT = (GroupLayout)$LAYOUT.select(new MemoryLayout.PathElement[]{MemoryLayout.PathElement.groupElement((String)"__data")});
    private static final long __data$OFFSET = 0L;
    ...
    private static long[] __size$DIMS = new long[]{56L};
    ...
    public static MemorySegment __data(MemorySegment union) {
        return union.asSlice(0L, __data$LAYOUT.byteSize());
    }

    public static void __data(MemorySegment union, MemorySegment fieldValue) {
        MemorySegment.copy((MemorySegment)fieldValue, (long)0L, (MemorySegment)union, (long)0L, (long)__data$LAYOUT.byteSize());
    }
    ...
    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(pthread_rwlock_t.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return pthread_rwlock_t.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)pthread_rwlock_t.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)pthread_rwlock_t.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return pthread_rwlock_t.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(pthread_rwlock_t.layout().byteSize() * elementCount, arena, cleanup);
    }
}
