...
public class pthread_mutexattr_t {
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout((MemoryLayout[])new MemoryLayout[]{MemoryLayout.sequenceLayout((long)4L, (MemoryLayout)Lib.C_CHAR).withName("__size"), Lib.C_INT.withName("__align")}).withName("$anon$32:9");
    ...
    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(pthread_mutexattr_t.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return pthread_mutexattr_t.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)pthread_mutexattr_t.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)pthread_mutexattr_t.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return pthread_mutexattr_t.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(pthread_mutexattr_t.layout().byteSize() * elementCount, arena, cleanup);
    }
}
