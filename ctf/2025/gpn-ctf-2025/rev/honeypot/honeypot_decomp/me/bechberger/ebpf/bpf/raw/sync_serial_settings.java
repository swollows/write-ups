...
public class sync_serial_settings {
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout((MemoryLayout[])new MemoryLayout[]{Lib.C_INT.withName("clock_rate"), Lib.C_INT.withName("clock_type"), Lib.C_SHORT.withName("loopback"), MemoryLayout.paddingLayout((long)2L)}).withName("$anon$40:9");
    ...
    public static MemorySegment asSlice(MemorySegment array, long index2) {
        return array.asSlice(sync_serial_settings.layout().byteSize() * index2);
    }

    public static long sizeof() {
        return sync_serial_settings.layout().byteSize();
    }

    public static MemorySegment allocate(SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)sync_serial_settings.layout());
    }

    public static MemorySegment allocateArray(long elementCount, SegmentAllocator allocator) {
        return allocator.allocate((MemoryLayout)MemoryLayout.sequenceLayout((long)elementCount, (MemoryLayout)sync_serial_settings.layout()));
    }

    public static MemorySegment reinterpret(MemorySegment addr2, Arena arena, Consumer<MemorySegment> cleanup) {
        return sync_serial_settings.reinterpret(addr2, 1L, arena, cleanup);
    }

    public static MemorySegment reinterpret(MemorySegment addr2, long elementCount, Arena arena, Consumer<MemorySegment> cleanup) {
        return addr2.reinterpret(sync_serial_settings.layout().byteSize() * elementCount, arena, cleanup);
    }
}
