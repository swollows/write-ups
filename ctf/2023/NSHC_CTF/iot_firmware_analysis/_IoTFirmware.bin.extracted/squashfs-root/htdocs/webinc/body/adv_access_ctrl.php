...
<div id="access_main">	
	...
	<div id="policytableframe" class="blackbox">
		...
		<table id="policytable" class="general" style="font-size:11px" >
			<tr>
				<th width="35px"><?echo i18n("Enable");?></th>
				<th width="45px"><?echo i18n("Policy");?></th>
				<th width="50px"><?echo i18n("Machine");?></th>
				<th width="50px"><?echo i18n("Filtering");?></th>
				<th width="45px"><?echo i18n("Logged");?></th>
				<th width="46px"><?echo i18n("Schedule");?></th>
				<th width="10px"> </th>
				<th width="10px"> </th>
			</tr>			
		</table>
...
<div id="access_port_filter" style="display:none;">
	<div class="blackbox">
		...
		<div>	
			<table class="general">	
				<tr>
					<td class="centered" width="40px"><?echo I18N("h","Enable");?></td>
					<td class="centered" width="100px"><?echo I18N("h","Name");?></td>
					<td class="centered" width="120px"><?echo I18N("h","Dest IP Start");?></td>
					<td class="centered" width="120px"><?echo I18N("h","Dest IP End");?></td>
					<td class="centered" width="60px"><?echo I18N("h","Protocol");?></td>
					<td class="centered" width="100px"><?echo I18N("h","Dest Port Start");?></td>
					<td class="centered" width="100px"><?echo I18N("h","Dest Port End");?></td>
				</tr>
<?
$INDEX = 1;
while ($INDEX <= 8)
{	
	...
	echo		"<option value='ALL'>".I18N("h","Any")."</option>"."\n";
