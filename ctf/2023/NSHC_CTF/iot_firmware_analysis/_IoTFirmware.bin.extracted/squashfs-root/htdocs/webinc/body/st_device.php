...
<div class="blackbox">
	...
	<div class="textinput" <? if(isfile("/htdocs/web/bsc_mydlink.php")==0 || query("/mydlink/register_st")!=1) echo "style='display:none;'";?>>
...
<div class="blackbox">
	...
	<table id="mld_groups" class="general" width="535px" <?if ($FEATURE_NOIPV6 == "1") echo ' style="display:none;"';?>>
			<tr>			
