...
Page.prototype =
{
	...
	DRAWLAN: function()
	{
		...
		var router = '<a href="./st_device.php"><img src="/pic/router.png" width="134" id="router" /></a></br><center><?echo I18N("j","INTERNET");?></center><center><span class="value" id="st_wanipaddr"></span></center>';
	...
	OnClickSLLink: function()
	{
		...
		if (!CheckSetValue(type)) return null;
		CheckSettings(this.saveonly, this.stages[this.currentStage]);
		PAGE.PreSubmit();
...
function CheckSettings(saveonly, current_stage)
{
