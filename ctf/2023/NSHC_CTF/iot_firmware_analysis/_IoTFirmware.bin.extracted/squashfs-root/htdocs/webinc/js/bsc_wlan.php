...
{	
	...
	SaveXML: function(wlan_uid)
	{
		...
		if (OBJ("wlan_mode"+str_Aband).value=="n" || OBJ("wlan_mode"+str_Aband).value=="gn" || OBJ("wlan_mode"+str_Aband).value=="bgn" || OBJ("wlan_mode"+str_Aband).value=="ac" || OBJ("wlan_mode"+str_Aband).value=="an" || OBJ("wlan_mode"+str_Aband).value=="acn" || OBJ("wlan_mode"+str_Aband).value=="acna")
		{
	...
	{
		if (!OBJ("auto_ch"+str_Aband).checked && ( OBJ("wlan_mode"+str_Aband).value == "n" || OBJ("wlan_mode"+str_Aband).value == "gn" || OBJ("wlan_mode"+str_Aband).value == "bgn" || OBJ("wlan_mode"+str_Aband).value == "ac" || OBJ("wlan_mode"+str_Aband).value == "an" || OBJ("wlan_mode"+str_Aband).value == "acn" || OBJ("wlan_mode"+str_Aband).value == "acna") )
		{
			...
			else
			{
				OBJ("bw"+str_Aband).disabled = false;
				this.OnChangeSecurityType(str_Aband);
				if(OBJ("wlan_mode"+str_Aband).value == "ac" || OBJ("wlan_mode"+str_Aband).value == "acn" || OBJ("wlan_mode"+str_Aband).value == "acna")
				COMM_AddSelectOptionIfNoExist(OBJ("bw"+str_Aband), "20+40+80", "20/40/80 MHz(<?echo I18N("j","Auto");?>)");
			}
//			this.OnChangeWLMode(str_Aband);	
		}
	},
	OnChangeBandwidth: function(str_Aband)
	{
		var phywlan = "";
	...
	OnClickEnAutoChannel: function(str_Aband)
	{
		...
		else if(OBJ("wlan_mode"+str_Aband).value == "ac" || OBJ("wlan_mode"+str_Aband).value == "acn" || OBJ("wlan_mode"+str_Aband).value == "acna")
		{
			this.bandWidth	= XG(phywlan+"/media/dot11n/bandwidth");
			COMM_AddSelectOptionIfNoExist(OBJ("bw"+str_Aband), "20+40+80", "20/40/80 MHz(<?echo I18N("j","Auto");?>)");
			COMM_SetSelectValue(OBJ("bw"+str_Aband), this.bandWidth);
		...
		switch (OBJ("security_type"+str_Aband).value)
		{
			case "":
				if (OBJ("wlan_mode"+str_Aband).value == "n" || OBJ("wlan_mode"+str_Aband).value == "gn" || 
					  ...
					  OBJ("wlan_mode"+str_Aband).value == "ac" || OBJ("wlan_mode"+str_Aband).value == "acn" || 
					  OBJ("wlan_mode"+str_Aband).value == "acna")
				{
					if(!OBJ("auto_ch"+str_Aband).checked && (OBJ("channel"+str_Aband).value=="140" || OBJ("channel"+str_Aband).value=="165" || OBJ("channel"+str_Aband).value=="12" || OBJ("channel"+str_Aband).value=="13"))
						OBJ("bw"+str_Aband).disabled = true;
					else 
						OBJ("bw"+str_Aband).disabled = false;
				}
	...
	{	
		...
		else if(OBJ("wlan_mode"+str_Aband).value == "ac" || OBJ("wlan_mode"+str_Aband).value == "acn" || OBJ("wlan_mode"+str_Aband).value == "acna")
		{
			...
			COMM_AddSelectOptionIfNoExist(OBJ("bw"+str_Aband), "20+40+80", "20/40/80 MHz(<?echo I18N("j","Auto");?>)");
			//if (this.bandWidth !== "20+40+80")
			//	COMM_SetSelectValue(OBJ("bw"+str_Aband), "20+40+80");
			//else
				COMM_SetSelectValue(OBJ("bw"+str_Aband), this.bandWidth);
			OBJ("bw"+str_Aband).disabled	= false;
		}		
    ...
    */
	...
	{ 
		...
		{
			alert("<?echo I18N("j", "The prefix or postfix of the 'Wireless Network Name' could not be blank.");?>");
			return false;
		}
		...
		else if(OBJ("security_type"+str_Aband).value==="wpa_personal")
		{
			...
			{
				alert("<?echo I18N("j", "The prefix or postfix of the 'Pre-Shared Key' could not be blank.");?>");
				return false;
			}
		}
		else if(OBJ("security_type"+str_Aband).value==="wpa_enterprise")
		{	
			...
			{
				alert("<?echo I18N("j", "The prefix or postfix of the 'RADIUS server Shared Secret' could not be blank.");?>");
				return false;
			}
			...
			if(radius_key_second!=="")
			{
				...
				{
					alert("<?echo I18N("j", "The prefix or postfix of the 'Second RADIUS server Shared Secret' could not be blank.");?>");
					return false;
				}
			}
		}
...
{	
	...
	var cond = bw+":"+sgi;
	var antenna_type = "<? echo $FEATURE_ANTENNA;?>";
	var antenna_type_24g = "<? echo $FEATURE_ANTENNA_24G;?>";
	var antenna_type_5g = "<? echo $FEATURE_ANTENNA_5G;?>";
...
function DrawSecurityList(wlan_mode, str_Aband)
{
	...
	if (wlan_mode === "n" || wlan_mode === "ac" || wlan_mode === "acn")
	{
