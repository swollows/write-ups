...
<div class="orangebox">
	<h1><?echo I18N("h","Wireless Network");?></h1>
	<p><?echo I18N("h","Use this section to configure the wireless settings for your D-Link router.")." ".
		I18N("h","Please note that changes made in this section may also need to be duplicated on your wireless client. ");?></p>
	<p><?echo I18N("h","To protect your privacy you can configure wireless security features.")." ".
		I18N("h","Securing your wireless network is important as it is used to protect the integrity of the information being transmitted. The router is capable of 4 types of wireless security; WEP, WPA only, WPA2 only, and WPA/WPA2 (auto-detect).");?></p>
...
<div id="div_24G" class="blackbox">
	<h2><?echo I18N("h","Wireless Network Settings");?></h2>
	<div class="textinput">
		<span class="name"><?echo I18N("h","Wireless Band");?></span>
		<span class="delimiter">:</span>
		<span class="value"><b><?echo I18N("h","2.4GHz Band");?></b></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo I18N("h","Enable Wireless");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			...
			if ($FEATURE_NOSCH!="1")
			{
				DRAW_select_sch("sch", I18N("h","Always"), "", "", "0", "narrow");
				echo '<input id="go2sch" type="button" value="'.I18N("h","New Schedule").'" onClick="javascript:self.location.href=\'./tools_sch.php\';" />\n';
			}
			?>
		</span>
	</div>
	<div class="textinput">
		<span class="name"><?echo I18N("h","Wireless Network Name");?></span>
		<span class="delimiter">:</span>
		<span class="value">
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","802.11 Mode");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wlan_mode" onChange="PAGE.OnChangeWLMode('');">
				...
				<option value="bg"><?echo I18N("h","Mixed 802.11g and 802.11b");?></option>
				<option value="gn"><?echo I18N("h","Mixed 802.11n and 802.11g");?></option>
				<option value="bgn"><?echo I18N("h","Mixed 802.11n, 802.11g and 802.11b");?></option>
			</select>
		</span>
	</div>	
...
?>			</select>
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","Transmission Rate");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<select id="txrate">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="bw" onChange="PAGE.OnChangeBandwidth('');">
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","Visibility Status");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="radio" class="name" id="ssid_visible" 		name="invisible_type" value="visible" 	onclick="PAGE.OnClickInvinsible('');" /> <label><?echo I18N("h","Visible");?></label>
	        <input type="radio" class="name" id="ssid_invisible" 	name="invisible_type" value="invisible" onclick="PAGE.OnClickInvinsible('');" /> <label><?echo I18N("h","Invisible");?></label>
		</span>
	</div>
	<div class="textinput" style="display:none;">
		<span class="name"><?echo I18N("h","WMM Enable");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="en_wmm" type="checkbox" />
			(<?echo I18N("h","Wireless QoS");?>)
		</span>
	</div>
	<div class="gap"></div>
</div>
<div class="blackbox">
	<h2><?echo I18N("h","Wireless Security Mode");?></h2>
	<div class="textinput">
		<span class="name" <? if(query("/runtime/device/langcode")!="en") echo 'style="width: 28%;"';?> ><?echo I18N("h","Security Mode");?></span>
		<span class="delimiter">:</span>
		<span class="value">
...
<div id="wep" class="blackbox" style="display:none;">
	<h2><?echo I18N("h","WEP");?></h2>
	<p><?echo I18N("h","WEP is the wireless encryption standard.")." ".
		...
		I18N("h",'For the most secure use of WEP set the authentication type to "Shared Key" when WEP is enabled.');?></p>
	<p><?echo I18N("h","You may also enter any text string into a WEP key box, in which case it will be converted into a hexadecimal key using the ASCII values of the characters.")." ".
		I18N("h","A maximum of 5 text characters can be entered for 64-bit keys, and a maximum of 13 characters for 128-bit keys.");?></p>
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","Authentication");?></span>
		<span class="delimiter">:</span>
		<span class="value">
	...
	<div class="textinput" style="display:none;">
		<span class="name"><?echo I18N("h","Default WEP Key");?></span>
		<span class="delimiter">:</span>
		<span class="value">
	...
	<div id="wep_64" class="textinput">
		<span class="name"><?echo I18N("h","WEP Key 1");?></span>
		<span class="delimiter">:</span>
		<span class="value">
...
<div id="box_wpa" class="blackbox" style="display:none;">
	<h2><?echo I18N("h","WPA");?></h2>
	<p><?echo I18N("","Use <strong>WPA or WPA2</strong> mode to achieve a balance of strong security and best compatibility.")." ".
		I18N("h","This mode uses WPA for legacy clients while maintaining higher security with stations that are WPA2 capable.")." ".
		I18N("","Also the strongest cipher that the client supports will be used. For best security, use <strong>WPA2 Only</strong> mode.")." ".
		I18N("h","This mode uses AES(CCMP) cipher and legacy stations are not allowed access with WPA security.")." ".
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","WPA Mode");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wpa_mode" onChange="PAGE.OnChangeWPAMode('');">
				<option value="WPA+2"><?echo I18N("h","Auto(WPA or WPA2)");?></option>
				<option value="WPA2"><?echo I18N("h","WPA2 Only");?></option>
				<option value="WPA"><?echo I18N("h","WPA Only");?></option>
			</select>
		</span>
	</div>		
	<div class="textinput">
		<span class="name"><?echo I18N("h","Cipher Type");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<select id="cipher_type" onChange="PAGE.OnChangeCipherType('');">
				<option value="TKIP">TKIP</option>
				<option value="AES">AES</option>
				<option value="TKIP+AES"><?echo I18N("h","TKIP and AES");?></option>
			</select>
		</span>
	</div>
	<div class="textinput">
		<span class="name"><?echo I18N("h","Group Key Update Interval");?></span>
		<span class="delimiter">:</span>
		<span class="value">
...
<div id="box_wpa_personal" class="blackbox" style="display:none;">
	<h2><?echo I18N("h","Pre-Shared Key");?></h2>
	<p class="strong"><?echo I18N("h","Enter an 8- to 63-character alphanumeric pass-phrase.")." ".
		I18N("h","For good security it should be of ample length and should not be a commonly known phrase.");?>
	</p>
	<div class="textinput">
...
<div id="box_wpa_enterprise" class="blackbox" style="display:none;">
	...
	<div class="textinput">
		<span class="name"><?echo I18N("h","RADIUS server IP Address");?></span>
		<span class="delimiter">:</span>
		<span class="value"><input id="radius_srv_ip" type="text" size="15" maxlength="15" /></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo I18N("h","RADIUS server Port");?></span>
		<span class="delimiter">:</span>
		<span class="value"><input id="radius_srv_port" type="text" size="5" maxlength="5" /></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo I18N("h","RADIUS server Shared Secret");?></span>
		<span class="delimiter">:</span>
	...
	<div id="div_second_radius" name="div_second_radius" style="display:none;">
		...
		<div class="textinput">
			<span class="name"><?echo I18N("h","Second RADIUS server IP Address");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="radius_srv_ip_second" type="text" size="15" maxlength="15" /></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo I18N("h","Second RADIUS server Port");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="radius_srv_port_second" type="text" size="5" maxlength="5" /></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo I18N("h","Second RADIUS server Shared Secret");?></span>
			<span class="delimiter">:</span>
...
<div id="div_5G" style="display:none;">
	<div class="blackbox">
		...
		<div class="textinput">
			<span class="name"><?echo I18N("h","Wireless Band");?></span>
			<span class="delimiter">:</span>
			<span id="wifi_mode_Aband" class="value"><b><?echo I18N("h","5GHz Band");?></b></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo I18N("h","Enable Wireless");?></span>
			<span class="delimiter">:</span>
			<span class="value">
				...
				if ($FEATURE_NOSCH!="1")
				{
					DRAW_select_sch("sch_Aband", I18N("h","Always"), "", "", "0", "narrow");
					echo '<input id="go2sch_Aband" type="button" value="'.I18N("h","New Schedule").'" onClick="javascript:self.location.href=\'./tools_sch.php\';" />\n';
				}
				?>
			</span>
		</div>
		...
		<div class="textinput">
			...
			<span class="value">
				<select id="wlan_mode_Aband" onChange="PAGE.OnChangeWLMode('_Aband');">
					...
					<option value="n"><?echo I18N("h","802.11n only");?></option>
					<? if ($FEATURE_NOACMODE=="0") echo '<option value="ac">'.I18N("h","802.11ac only").'</option>\n';?>
					<option value="an"><?echo I18N("h","Mixed 802.11a and 802.11n");?></option>
					<? if ($FEATURE_NOACMODE=="0") echo '<option value="acn">'.I18N("h","Mixed 802.11ac and 802.11n").'</option>\n';?>
					<? if ($FEATURE_NOACMODE=="0") echo '<option value="acna">'.I18N("h","Mixed 802.11ac, 802.11n and 802.11a").'</option>\n';?>
				</select>
			</span>
		</div>
	...
	?>			</select>
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value">
				<select id="bw_Aband" onChange="PAGE.OnChangeBandwidth('_Aband');">
					<option value="20">20 MHz</option>
					<option value="20+40">20/40 MHz(<?echo I18N("h","Auto");?>)</option>
					<option value="20+40+80">20/40/80 MHz(<?echo I18N("h","Auto");?>)</option>
				</select>
			</span>
		</div>
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value">
				<input type="radio" class="name" id="ssid_visible_Aband" 	name="invisible_type_Aband" value="visible"  	/> <label><?echo I18N("h","Visible");?></label>
				<input type="radio" class="name" id="ssid_invisible_Aband" 	name="invisible_type_Aband" value="invisible" /> <label><?echo I18N("h","Invisible");?></label>
			</span>
		</div>
		<div class="textinput" style="display:none;">
			<span class="name"><?echo I18N("h","WMM Enable");?></span>
	...
	<div id="box_wpa_Aband" class="blackbox" style="display:none;">
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value">
				<select id="cipher_type_Aband" onChange="PAGE.OnChangeCipherType('_Aband');">
					<option value="TKIP">TKIP</option>
					<option value="AES">AES</option>
					<option value="TKIP+AES"><?echo I18N("h","TKIP and AES");?></option>
				</select>
