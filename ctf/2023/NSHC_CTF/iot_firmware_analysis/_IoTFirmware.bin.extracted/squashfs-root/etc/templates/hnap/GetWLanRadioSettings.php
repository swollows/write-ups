...
$path_run_wlan = XNODE_getpathbytarget("/runtime", "phyinf", "uid", query($path_phyinf_wlan."/uid"), 0);
...
else
{
	...
	else if( $wlanMode == "acn" )	{ $wlanStr = "802.11acn"; }
	else if( $wlanMode == "acna" )	{ $wlanStr = "802.11acna"; }
	else						{ $result = "ERROR"; }
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
	...
	<soap:Body>
		<GetWLanRadioSettingsResponse xmlns="http://purenetworks.com/HNAP1/">
			...
			<MacAddress><? echo get("x",$path_run_wlan."/macaddr");?></MacAddress>
