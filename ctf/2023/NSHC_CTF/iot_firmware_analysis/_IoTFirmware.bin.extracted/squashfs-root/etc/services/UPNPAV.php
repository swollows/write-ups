...
$Genericname = query("/runtime/device/upnpmodelname");
if($Genericname == ""){ $Genericname = "D-Link Router";}
$Genericname = "Windows Media Connect compatible (".$Genericname.")";
...
if ($stsp!="")
{
	...
	if ($phy!="")
	{
		...
		if ($phyp!="" && query($phyp."/valid")=="1")
		    {$net_inf = query($phyp."/name");}
	}
}

$dev_url=query($stsp."/inet/ipv4/ipaddr");
if(isempty($dev_url)== 1)
    {$dev_url="192.168.0.1";}
