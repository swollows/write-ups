...
else if ($ACTION=="deconfig")
{
	...
	else
	{
		if ($sts."upperlayer" != "")
		{
			// when in pptp mode and udhcpc deconfig. udhcpc will bound immediately
			// cause wan up again. so DHCP RELEASE it. udhcpc will be kill after 
			// pppd finished.
			echo "kill -SIGUSR2 `cat /var/servd/".$INF."-udhcpc.pid`\n";
		}
		del($sts."/udhcpc");
