...
function inet_ipv4_dynamic($inf, $ifname, $inet, $inetp)
{
	...
	//i modify event handler installation procedure, because those events are shared
	//DO NOT flush them, use "insert" and "remove" (tom, 20130611)
	...
	startcmd(
		...
		'event WANPORT.LINKUP remove DHCP\n'.
		'event WANPORT.LINKUP insert DHCP:'.$WANPORTLINKUP.'\n'.
		'event WANPORT.LINKDOWN remove DHCP\n'.
		'event WANPORT.LINKDOWN  insert DHCP:'.$WANPORTLINKDOWN.'\n'.
